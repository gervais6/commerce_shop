   ...
   <nav class="navbar navbar-expand-lg navbar_light bg-light"> <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
         <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
               <a class="nav-link active" style="font-weight: bold;" aria-current="page" href="../shop_admin/">Nouveau</a>
            </li>
                 <li class="nav-item">
...
<div class="container">
   ...
   <form method="post">
      <div class="mb-3">
         ...
         <input type="name" class="form-control "name="image_produit" required>
 ...
 <div class="mb-3">
       ...
       <div class="mb-3">
         ...
         <textarea  class="form-control" name="description_produit" required ></textarea>
